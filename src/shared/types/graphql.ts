...
export type GetProfileQuery = { __typename?: 'Query', getProfile: { __typename?: 'UserEntity', _id: string, email: string } };
...
export type RegisterMutation = { __typename?: 'Mutation', register: { __typename?: 'UserEntity', _id: string, email: string, login: string } };
...
export const RegisterDocument = gql`
    mutation register($email: String!, $password: String!, $login: String!, $phoneNumber: String!, $username: String!) {
  register(
    createUserInput: {email: $email, password: $password, login: $login, phoneNumber: $phoneNumber, username: $username}
  ) {
    _id
    email
    login
